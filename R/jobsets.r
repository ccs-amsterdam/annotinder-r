...
#' @param set               A character vector with unit IDs. If empty, all regular (i.e. not pre or post) units in the codingjob will be used
#' @param pre_set           A character vector with unit IDS for pre units. If empty, all pre units will be used
#' @param post_set           A character vector with unit IDS for post units. If empty, all post units will be used
#'
#' @details
...
jobset <- function(name, codebook=NULL, set=NULL, pre_set=NULL, post_set=NULL) {
