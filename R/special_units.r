...
#' @param markdown Alternatively, provide the content as a markdown string. If used, title+text are ignored. See \url{https://commonmark.org/help/} for help.
...
#'
#' @examples
create_question_unit <- function(id, ..., title=NULL, text=NULL, markdown=NULL, text_window_size=NULL) {
